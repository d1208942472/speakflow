        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col gap-6 text-center lg:text-left">
            ...
            <div className="flex items-center gap-3 justify-center lg:justify-start">
              <div className="inline-flex items-center gap-2 bg-nvidia/10 border border-nvidia/30 rounded-full px-4 py-2">
                <span className="w-2 h-2 bg-nvidia rounded-full animate-pulse" />
                <span className="text-nvidia text-sm font-semibold">Early Access Open — Founding Member Pricing</span>
              </div>
            </div>
